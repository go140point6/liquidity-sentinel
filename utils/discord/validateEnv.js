...
function validateEnv() {
  ...
  const requiredVars = [
    ...
    "PRIMEFI_WITHDRAW_ALERT_TRIGGER_UNITS",
    "PRIMEFI_WITHDRAW_ALERT_RESET_UNITS",
    "LOAN_REDEMPTION_EVENT_BOOTSTRAP_LOOKBACK_BLOCKS",
    "LOAN_REDEMPTION_EVENT_STAGE_25_PCT",
    "LOAN_REDEMPTION_EVENT_STAGE_50_PCT",
    "LOAN_REDEMPTION_EVENT_STAGE_75_PCT",
