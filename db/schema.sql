...
CREATE TABLE loan_redemption_event_cursors (
  contract_id         INTEGER PRIMARY KEY,
...
CREATE TABLE loan_redemption_events (
  id                        INTEGER PRIMARY KEY AUTOINCREMENT,
  chain_id                  TEXT NOT NULL,
  contract_id               INTEGER NOT NULL,
  protocol                  TEXT NOT NULL,
...
CREATE INDEX idx_loan_redemption_events_position
  ON loan_redemption_events(contract_id, trove_id, id);

CREATE INDEX idx_loan_redemption_events_block
...
CREATE TABLE primefi_withdraw_alert_state (
  id            INTEGER PRIMARY KEY AUTOINCREMENT,
  user_id       INTEGER NOT NULL,
  wallet_id     INTEGER NOT NULL,
  chain_id      TEXT NOT NULL,
...
CREATE INDEX idx_primefi_withdraw_alert_state_user
  ON primefi_withdraw_alert_state(user_id, is_active);

CREATE TABLE primefi_withdraw_alert_log (
  id            INTEGER PRIMARY KEY AUTOINCREMENT,
  user_id       INTEGER NOT NULL,
  wallet_id     INTEGER NOT NULL,
  chain_id      TEXT NOT NULL,
...
CREATE INDEX idx_primefi_withdraw_alert_log_user
